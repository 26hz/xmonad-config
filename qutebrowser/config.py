...
c.fonts.keyhint = "18px Sarasa Fixed SC Nerd Font"
c.fonts.messages.info = "18px Sarasa Fixed SC Nerd Font"
c.fonts.messages.error = "18px Sarasa Fixed SC Nerd Font"
c.fonts.prompts = "18px Sarasa Fixed SC Nerd Font"
...
## [String]
c.hints.border = '2px solid ' + '#3b4252'
